        ...
        <div className="min-h-screen bg-gradient-to-b from-surface to-background">
            ...
            <section className="max-w-5xl mx-auto px-8 pt-32 pb-20">
                <div className="text-center">
                    <h1 className="text-5xl md:text-6xl font-serif font-semibold text-foreground mb-12 tracking-wide">
                        {poet?.name || '李瑜'}
                    </h1>
            ...
            <section className="max-w-3xl mx-auto px-8 pb-20">
                <div className="bg-background rounded-2xl shadow-sm border border-border p-12">
                    <h2 className="text-2xl font-serif font-semibold text-foreground mb-6 text-center tracking-wide">
                        诗人小传
                    </h2>
                    <p className="font-serif text-foreground leading-[2] text-lg tracking-[0.03em]">
                        {poet?.bio || '诗人信息加载中...'}
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-5xl mx-auto px-8 pb-32">
                <h2 className="text-3xl font-serif font-semibold text-foreground mb-12 text-center tracking-wide">
                    作品
                </h2>
                ...
                {books.length > 0 && (
                    <div className="mb-16">
                        <h3 className="text-xl font-sans font-medium text-foreground mb-6 uppercase tracking-wider">
                            诗集
                        </h3>
                            ...
                            {essays.map(essay => (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-start mb-2">
                                        <h4 className="text-lg font-serif font-semibold text-foreground group-hover:text-accent transition line-clamp-2 pr-4 tracking-wide">
                                            {essay.title}
                                        </h4>
                                    </div>
            ...
            <footer className="border-t border-border py-12">
                <div className="max-w-5xl mx-auto px-8 flex flex-col items-center justify-center space-y-2 text-foreground-subtle text-xs">
                    ...
                    <p className="mt-2 text-xs text-foreground-subtle">
                        <a href="https://github.com/lukethecat/lukethecat.github.io/deployments" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition">最后部署于 {process.env.NEXT_PUBLIC_BUILD_TIME} (第 {process.env.NEXT_PUBLIC_GIT_COMMIT_COUNT} 次)</a>
                    </p>
                    <FooterEasterEgg />
