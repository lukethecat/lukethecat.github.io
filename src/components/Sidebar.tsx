...
export const Sidebar: React.FC<SidebarProps> = ({
            ...
            return (
                <div className="flex flex-col items-center py-4 h-full">
                    <button
                        ...
                        className="p-2 hover:bg-sidebar-active rounded transition mb-4"
                        title="展开侧边栏"
                    >
                    ...
                    <Link
                        href="/"
                        className="p-2 hover:bg-sidebar-active rounded transition"
                        title="返回首页"
                    >
            ...
            <div className="flex flex-col h-full">
                <div className="p-4 border-b border-border">
                    <div className="flex items-center justify-between mb-2">
                        ...
                        <button
                            onClick={onToggleDesktop}
                            className="hidden md:block p-1 hover:bg-sidebar-active rounded transition"
                            title="折叠侧边栏"
                        >
                        ...
                        <button
                            ...
                            className="md:hidden p-1 hover:bg-sidebar-active rounded transition"
                            title="关闭菜单"
                        >
                            <X className="w-4 h-4 text-foreground-muted" />
                        </button>
                    </div>
                    <h1 className="font-semibold text-foreground mb-1 font-serif tracking-wide">{book.title}</h1>
    ...
    return (
        <>
            ...
            <aside
                className={`
                    hidden md:block fixed left-0 top-0 h-screen bg-sidebar-bg border-r border-border 
            ...
            <aside
                className={`
                    md:hidden fixed inset-y-0 left-0 z-50 w-72 bg-sidebar-bg border-r border-border 
