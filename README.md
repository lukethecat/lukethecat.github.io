...
**李瑜**（1939— ），当代著名西部诗人、新边塞诗代表人物。数字档案馆收录其代表性诗集《汗血马》《准噶尔诗草》《黑罂粟》等全文，涵盖丝绸之路、天山、伊犁河、新疆兵团等西域主题。原籍安徽巢县，生于重庆，长在武汉。1964年从武汉支边到新疆，先后在兵团基层单位当过修理工、农工和中小学教师。诗风忧伤、缠绵、轻柔、淡远，被誉为新边塞诗"婉约派"代表诗人。

---

## 许可协议

本项目的代码和内容实行完全开源的版权结构：
- **源代码**：基于 [MIT License](LICENSE) 开源。
- **诗歌与文章内容**：基于 [知识共享署名 4.0 国际许可协议 (CC BY 4.0)](https://creativecommons.org/licenses/by/4.0/deed.zh-hans) 开放共享。您可以自由分享、演绎本项目中的内容，只需给出适当的署名即可。
